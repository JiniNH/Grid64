...
![Status](https://img.shields.io/badge/Status-Closed_Testing_v1.1.0-brightgreen?style=for-the-badge)
...
2. Drag a block from the bottom deck onto the 8×8 grid.
3. Fill an entire row or column to clear it and score.
4. Chain clears back-to-back to build combos and charge the Fever gauge.
5. Clear a row and column at once for a Perfect bonus.
6. Use all 3 blocks to spawn a new set — Classic ends when nothing fits, Time Attack ends when the clock runs out.
...
| ----- | ------ | ------- |
| UI icons, UI pack, audio | [Kenney](https://kenney.nl) | CC0 1.0 |
| NanumSquareNeo | [NAVER](https://hangeul.naver.com/font) | SIL OFL 1.1 |

Buttons, panels, and the app icon are original work.

- [Privacy Policy](https://jininh.github.io/jiniworks-privacy/grid64.html)
- [Open Source Licenses](https://jininh.github.io/jiniworks-privacy/grid64-licenses.html)
